...
class TypeSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Type::create(['sr' => 11, 'name' => 'Stanza', 'display_style' => 'simple', 'default_title' => 'Explain the following with reference to context']);
        ...
        Type::create(['sr' => 19, 'name' => 'Comprehension', 'display_style' => 'simple', 'default_title' => "Read the following passage carefully and answer the quesitons given at the end"]);
        ...
        Type::create(['sr' => 32, 'name' => 'اشعار کی تشریح', 'display_style' => 'simple', 'default_title' => "درج ذیل اشعار کی تشریح کیجیے"]);
        ...
        Type::create(['sr' => 36, 'name' => ' عبارت سے سوالات', 'display_style' => 'simple', 'default_title' => "دی گئی عبارت کو غور سے پڑھیں اور آخر میں دیے گئے سوالات کے جوابات تحریر کیجیے"]);
