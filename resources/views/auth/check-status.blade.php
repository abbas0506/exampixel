...
<div class="flex flex-col w-screen h-screen justify-center items-center px-5">
    <div class="md:w-1/3 md:px-8 py-3 bg-white relative mb-8">
        ...
        <form action="{{url('check-status')}}" method="post" class="flex flex-col mt-3">
            @csrf
            ...
            <div class="flex space-x-4">
                <button type="submit" class="w-full mt-6 btn-teal p-2">Check Status</button>
            </div>
        </form>
