...
<div class="grid h-screen place-items-center bg-white p-5">
    <div class="grid gap-4 w-full md:w-1/2 mx-auto text-center">
        ...
        <h1 class="text-2xl text-teal-600 mt-3">Already Verified</h1>
        <p class="text-slate-600">Enjoy quick paper generation. Default password is "000", you may change it at any time by using "Reset Password" option</p>
    </div>
