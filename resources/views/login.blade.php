...
<div class="flex h-screen items-center justify-center bg-white p-5">
    ...
    <div class="grid place-items-center w-full md:w-1/3 lg:1/4 mx-auto">
        ...
        <div class="p-5 bg-teal-50 border border-teal-100 rounded mt-4 text-xs">
            Respected user, <br>If you have recently signed up but dont know the password, please check your <b>inbox or spam folder</b>. However, if you have deleted the email, no issue, go to <b>Forgot Password</b> and ask for a new password.
        </div>
