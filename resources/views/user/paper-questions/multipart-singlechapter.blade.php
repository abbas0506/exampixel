            ...
            <form id='data-form' action="{{ route('user.papers.multipart-singlechapter-questions.store', $paper) }}" method="post">
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="choices" class="custom-input-borderless" value="0" min=0>
                    </div>

                    <div class="col-span-2">
                        <label for="">Question Title</label>
                        <input type="text" name="question_title" value="" class="custom-input-borderless" placeholder="Questoin title" required>
                    </div>
                </div>
            </form>
