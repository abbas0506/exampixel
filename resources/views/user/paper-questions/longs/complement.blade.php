    ...
    <div class="container">
        <div class="flex flex-row justify-between items-center">
            <div class="bread-crumb">
                <a href="{{ url('/') }}">Home</a>
                <div>/</div>
                <a href="{{ route('user.papers.show', $paperQuestion->paper) }}">Paper</a>
                <div>/</div>
                <div>Add Long</div>
            </div>
        </div>
        ...
        <form id='data-form' action="{{ route('user.paperQuestions.complementQuestions.store', $paperQuestion) }}" method="post">
            @csrf
            ...
            <div class="flex flex-col md:flex-row md:items-center gap-8 bg-slate-100 border border-dashed rounded-lg p-5 mt-5">
                ...
                <div class="flex flex-col md:w-1/4" id='marks'>
                    <label>Marks</label>
