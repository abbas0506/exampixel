...
<div class="responsive-container">
    <div class="container">
        ...
        <div class="grid gap-6 md:w-3/4 mx-auto mt-6">
            <h2>Long Q. simple (statement only)</h2>
            <form id='data-form' action="{{ route('user.papers.simpleQuestions.store', $paper) }}" method="post">
                @csrf

                <input type="hidden" name="question_type" value="10">
                <input type="hidden" name="question_title" value="Read following paragraph and answer the questions">
