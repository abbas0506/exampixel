...
<div class="responsive-container">
    <div class="container">
        ...
        <div class="grid gap-6 md:w-3/4 mx-auto mt-6">
            <h2>{{ $questionTitle }}</h2>
            <form id='data-form' action="{{ route('user.papers.simpleQuestions.store', $paper) }}" method="post">
                @csrf
                ...
                <div class="flex flex-col gap-5">
                    ...
                    @if($choice==3 || $choice==9 || $choice==10)
                    <div>
                        <label for="">Question Title</label>
                        <input type="text" name="question_title" value="" class="custom-input-borderless" required>
                    </div>
                    @else
                    <input type="hidden" name="question_title" value="" class="custom-input-borderless">
                    @endif
                </div>
            </form>
