        ...
        <div class="content-section rounded-lg mt-2">
                ...
                <div class="flex flex-col md:flex-row gap-3 items-center md:items-end">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="flex items-center space-x-3">
                            <label>{{$paper->title}}</label> <a href="{{route('user.papers.edit',$paper)}}" class="btn-sky flex justify-center items-center rounded-full p-0 w-5 h-5"><i class="bx bx-pencil text-xs"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center mt-6 border bg-slate-200 border-teal-600 rounded-lg text-left p-3 px-5">
                ...
                <div class="flex p-4 rounded gap-x-2 text-green-400 text-sm relative">
                    ...
                    <a href="{{route('user.papers.wholeQuestions.create',$paper)}}" class="btn-red rounded">Long</a>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-2 mt-3">
                ...
                <div class="question mcq">
                    <div class="head">
                        ...
                        <div class="action border border-green-200 rounded bg-green-50 mx-2">
                            <form action="{{ route('user.paper.questions.destroy',[$paper, $paperQuestion]) }}" method="post">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="body">
                        ...
                        <div class="sub">
                            ...
                            <div class="action">
                                <a href="{{ route('user.paper-question-parts.refresh',$paperQuestionPart) }}"><i class="bi-arrow-repeat"></i></a>
                            </div>
                        </div>
                        <div class="choices">
                            <div class="choice">
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex items-center space-x-3">
                        <a href="{{ route('user.paper-question-parts.refresh', $paperQuestionPart) }}"><i class="bi-arrow-repeat text-cyan-600"></i></a>
                ...
                <div class="flex items-center flex-wrap">
                    ...
                    <div class="flex items-center w-full">
                        ...
                        <div class="w-12">Q. {{ $QNo++ }}</div>
                        <div class="flex-1 text-left">{{ $paperQuestionPart->question->statement }}</div>
                        <a href="{{ route('user.paper-question-parts.refresh', $paperQuestionPart) }}" class="ml-2"><i class="bi-arrow-repeat text-cyan-600"></i></a>

                        @else
                        <div class="w-12"></div>
                        <div class="flex-1 text-left "> <span class="font-semibold">OR</span> &nbsp {{ $paperQuestionPart->question->statement }}</div>
                        <a href="{{ route('user.paper-question-parts.refresh', $paperQuestionPart) }}" class="ml-2"><i class="bi-arrow-repeat text-cyan-600"></i></a>
                        @endif
                    </div>
                    ...
                    <div class="flex items-center mt-2">
                        <div class="w-12"></div>
                        <a href="{{ route('user.paperQuestions.alternativeLongs.create', $paperQuestion) }}" class="btn-blue text-xs w-16">+ OR</a>
                    </div>
