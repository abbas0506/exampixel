...
@section('header')
<x-headers.user page="Simpe PDF!" icon="<i class='bi bi-emoji-smile'></i>"></x-headers.user>
@endsection
...
<div class="responsive-container">
    <div class="container">
        ...
        <div class="content-section rounded-lg mt-2">
            ...
            <div class="grid md:grid-cols-2 items-end gap-4 mt-6">
                <div class="flex flex-col md:flex-row gap-3 items-center md:items-end">
                    <img src="{{url('images/small/pdf.png')}}" alt="paper" class="w-16">
            ...
            <form action="{{route('user.papers.simple-pdf.store',$paper)}}" method="post">
                @csrf
