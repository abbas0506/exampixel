                                ...
                                <td class='@if ($j != 1) pl-8 @endif'>
                                    ...
                                    <table class="w-full">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="2" class="m-0 p-0 font-bold">Govt Higher Secondary
                                                    School Chak Bedi</td>
                                            </tr>

                                            <tr>
                                                <td colspan="2" class="m-0 p-0">{{ $paper->title }} Dated
                                                    {{ $paper->paper_date->format('d/m/Y') }}</td>
                                            </tr>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($paper->paperQuestions as $paperQuestion)
                                                    @if ($paperQuestion->type_id == 1)
                                                        <tr>
                                                            <td class="text-left font-bold">Q.{{ $QNo++ }}
                                                    ...
                                                    @if ($paperQuestion->type_id == 2)
                                                        <tr>
                                                            <td class="text-left font-bold">Q.{{ $QNo++ }}
                                                                {{ $paperQuestion->question_title }}</td>
                                                            <td>{{ $paperQuestion->necessary_parts }}x2={{ $paperQuestion->necessary_parts * 2 }}
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td colspan="2" class="text-left">
                                                                <ol class="lower-roman ml-4">
                                                                    @foreach ($paperQuestion->paperQuestionParts as $paperQuestionPart)
                                                                        <li>{{ $paperQuestionPart->question->statement }}
                                                                        </li>
                                                                    @endforeach
                                                                </ol>
                                                            </td>
                                                                ...
                                                                @if ($loop->first)
                                                                    <tr>
                                                                        <td class="text-left" colspan="2">
                                                                            <ul
                                                                                class="list-horizontal w-full font-bold">
                                                                                <li class="w-8">
                                                                                    Q.{{ $QNo++ }}</li>
                                                                                <li style='width:90%'>
                                                                                    {{ $paperQuestionPart->question->statement }}
