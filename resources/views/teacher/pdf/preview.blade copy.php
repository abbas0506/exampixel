                        ...
                        @for($j=1; $j<=$cols;$j++) @php $questionNo=1; @endphp <td class='@if($j!=1) pl-8 @endif'>
                            ...
                            <table class="table-auto w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-left font-bold">Q.{{$questionSr++}} @if($paperQuestion->paperQuestionParts->count()==$paperQuestion->necessary_parts)
                                            <span>Encircle the correct option</span>
                                            @else
                                            <span>Encircle the correct option. (any {{SpellNumber::value($paperQuestion->necessary_parts)->toLetters()}})</span>
                                            @endif
                                        </td>
                                        <td></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td class="text-left font-bold">Q.{{$questionSr++}}
                                            ...
                                            @else
                                            <span>Answer any {{SpellNumber::value($paperQuestion->necessary_parts)->toLetters()}} questions.</span>
                                            @endif
                                        </td>
                                    ...
                                    <tr>
                                        <td class="text-left" colspan="2">
                                            ...
                                            <ul class="list-horizontal w-full font-bold">
                                                <li style='width:90%'>Q.{{$questionSr++}} {{$paperQuestion->paperQuestionParts->first()->question->statement}}</li>
                                    ...
                                    @else
                                    <tr>
                                        <td class="text-left font-bold" colspan="2">Q.{{$paperquestion->statement_no}} Answer the following</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="text-left">
                                            <ol class="lower-alpha ml-4">
                                                ...
                                                <li>
                                                    <ul class="list-horizontal w-full">
                                                        ...
                                                        <li class="w-4 text-right">{{$paperQuestionPart->marks}}</li>
                                                    </ul>
                                                </li>
                                                @endforeach
                                            </ol>
