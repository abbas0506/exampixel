        ...
        <div class="content-section">
            ...
            <div class="flex justify-end w-full">
                <div class="flex w-12 h-12 items-center justify-center rounded-full bg-orange-100 hover:bg-orange-200">
                    <a href="{{ route('teacher.papers.keys.pdf',$paper) }}" target="_blank"><i class="bi-printer"></i></a>
                </div>
            </div>
            @endif
            ...
            <div class="flex flex-wrap gap-5 mt-3">
                ...
                <div class="bg-slate-200 px-3 rounded">{{$i++}}. {{ ucfirst($paperQuestionPart->question->mcq->correct)}}</div>
                @endforeach
                @endforeach
            </div>
            @else
